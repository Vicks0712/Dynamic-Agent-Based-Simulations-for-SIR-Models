...
from src.webapp.views.sirsv.components.Parameters import Parameters
...
class SIRSVModelView:
    ...
    def initialize_view(self):
        ...
        st.title("SIRSV Model Simulation 🦠")
        st.subheader(
            "Simulate the spread of a sir in a network using the SIRSV model. Adjust the parameters to observe how the sir propagates over time."
        )
    ...
    def create_model(self):
        ...
        return SIRSModel(
            ...
            immunity_loss_chance=self.params["Immunity Loss Chance"],
